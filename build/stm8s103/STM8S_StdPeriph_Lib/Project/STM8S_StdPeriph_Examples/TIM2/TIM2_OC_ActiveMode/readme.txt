/** @page TIM2_OC_ActiveMode Generate three different signals with three different delays with Active Mode
  ...
  ******************************************************************************
  ...
  This example shows how to configure the TIM2 peripheral to generate three different 
  ...
  The delay corresponds to the time difference between PG.6 and TIM2_CHx signal 
  rising edges
