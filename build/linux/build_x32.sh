...
gcc -m32 -O2 -s -I../../include -Wall "${ST_SOURCE[@]}" "${ASM_SOURCE[@]}" ../../examples/ex0_task.c -o ex0_task 

gcc -m32 -O2 -s -I../../include -Wall "${ST_SOURCE[@]}" "${ASM_SOURCE[@]}" ../../examples/ex1_event.c -o ex1_event

gcc -m32 -O2 -s -I../../include -I../../libuv/include -I../../libuv/src -Wall\
