...
| ARMv6-M (M051, 树莓派 Raspberry-Pico) | :heavy_check_mark: | :x:                |
...
| 树莓派 Raspberry-Pico      | build\raspberrypi_pico\CMakeLists.txt | [pico-sdk](https://github.com/raspberrypi/pico-sdk) |
